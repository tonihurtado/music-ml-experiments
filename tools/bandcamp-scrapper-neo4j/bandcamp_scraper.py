...
def getGenreAlbums(tag, start_page = 1, end_page = 99):
...
def saveAlbum(album_old, keys):
    ...
    if album == None:
        ...
        artist = dbt.createArtist(album_old[keys["band"]],album_old[keys["bid"]])
        dbt.addArtisttoAlbum(artist,album)
